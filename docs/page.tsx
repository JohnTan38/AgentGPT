...
export default function EnhancedCdasDocs() {
  ...
  const handleExternalLink = () => {
    ...
    const sectionUrls = {
      'overview': 'https://github.com/cdas-system/docs',
      'business-process-automation-with-ai': 'https://youtu.be/qxFhSLAmvzw?si=5Z6gHe3mixwm6X-v',
      'authentication': 'https://docs.cdas.com/auth',
      'workflow': 'https://docs.cdas.com/workflow',
      'user-guide-reference': 'https://cdas-unformed.vercel.app',
      'user-reviews': 'https://user-review-beta.vercel.app/',
      'troubleshooting': 'https://support.cdas.com'
    };
